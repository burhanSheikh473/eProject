...
<body>
    ...
    <div class="sidebar">
        ...
        <hr>
            <ul class="main">
                ...
                <li>
                    <a href="./vaccinationdetails1.php"  >
        ...
        <div class="main-content">
            <div class="header">
                <div class="title">
                    <h1>My Dashboard</h1>
                       <h4>_CovidCare (Update Vacccine)</h4>
                </div>
            </div>
    ...
    <?php
       ...
       if($result){
        echo "<script>
           window.location.href='./vaccinationdetails1.php';
        </script>";
       }
    }
    ?>
