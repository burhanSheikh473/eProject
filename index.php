...
<body class="main-layout">
            ...
            <!-- <div class="container-fluid ">
                  ...
                  <div class="dropdown">
                <button class="btn btn-danger dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false"> Login System </button>
              <ul class="dropdown-menu">
    <li><a class="dropdown-item" href="hospitallogin.php">Hospital LogIn</a></li>
    <li><a class="dropdown-item" href="adminlogin.php">Admin Login</a></li>
    <li><a class="dropdown-item" href="loginuser.php">User Login</a></li>
  </ul>
</nav>
</div>
        </div>
                  ...
                  <div class="owl-carousel owl-theme">
                     <div class="item">
                        <div class="protect_box text_align_center">
                          <div class="desktop">
                           ...
                           <h3> Wear Mask</h3>
                           <span> "Wearing a mask is essential to prevent COVID-19 transmission. It acts as a simple yet effective barrier, protecting both you and others. By wearing a mask, you contribute to the collective effort to ensure everyone's safety."</span>
                          </div>
                     ...
                     <div class="item">
                          ...
                          <div class="desktop">
                           ...
                           <span>"Frequent handwashing is a vital step in halting the spread of germs. This straightforward yet impactful habit not only safeguards you but also shields others, fostering a healthier and more hygienic environment for everyone clean hand always"</span>
                          </div>
                           <a class="read_more" href="protect.php">Read More</a>
                        </div>
                     </div>
                     <div class="item">
                         <div class="protect_box text_align_center">
                          <div class="desktop">
                           ...
                           <h3> Stay at Home</h3>
                           <span>"Amidst global challenges, prioritize safety by staying at home. Your steadfast commitment to social responsibility ensures collective well-being. Together, we can overcome adversity, protect loved ones, and build a resilient future. #StayHome #StaySafe"</span>
                          </div>
                           <a class="read_more" href="protect.php">Read More</a>
                        </div>
                     </div>
               ...
               <div class="container">
                  <div class="row">
                     <div class="col-md-8 offset-md-2">
                        <p>© 2020 All Rights Reserved. Design by <a href="https://php.design/"> Free html Templates</a></p>
                     </div>
                  </div>
               </div>
            </div>
