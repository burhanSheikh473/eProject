...
<html lang="en">
   <head>
      ...
      <style>
         ...
         .form-container form .c-btn{
            background-color: #0a264a;
            color: #fff;
            font-size: 18px;
         }
         .form-container form .c-btn:hover{
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-md-6 form-container">
                  <h2>Contact Us</h2>
               <form method="post" >
<input type="text" placeholder="Enter Name" name="cname"><br><br>
<input type="text" placeholder="Enter Contact" name="cphone"><br><br>
<input type="text" placeholder="Enter Email" name="cemail"><br><br>
<input type="text" placeholder="Enter Message" name="cmessage"><br><br>
<input type="submit" value="Send" name="btnsend" class="c-btn">
    </form>
               </div>
                <div class="col-md-6">
...
if(isset($_POST['btnsend'])){
    ...
    $query = "INSERT INTO tbl_contact(Name,Contact,Email,Message)VALUES('$name', '$phone','$email','$message')";
    $result = mysqli_query($con,$query);
    if($result){

        echo "<script>
        alert('Your request us submitted');
